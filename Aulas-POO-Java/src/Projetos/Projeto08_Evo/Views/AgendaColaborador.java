 ...
 * @author junio
 */
public class AgendaColaborador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        campoCargo.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        campoCargo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                campoCargoActionPerformed(evt);
            }
        });
        getContentPane().add(campoCargo, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 470, 270, -1));

        jLabelCargo.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        jLabelCargo.setForeground(new java.awt.Color(255, 255, 255));
        jLabelCargo.setText("Cargo:");
        getContentPane().add(jLabelCargo, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 470, -1, -1));

        campoProfissao.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        campoProfissao.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                campoProfissaoActionPerformed(evt);
            }
        });
        getContentPane().add(campoProfissao, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 420, 270, -1));

        jLabelProfissao.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        jLabelProfissao.setForeground(new java.awt.Color(255, 255, 255));
        jLabelProfissao.setText("Profissão:");
        getContentPane().add(jLabelProfissao, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 420, -1, -1));
        ...
        getContentPane().add(jLabelAreaCadastro, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 920, 370));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgendaColaborador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgendaColaborador().setVisible(true);
            }
        });
    }
